...
\end{align*}
D'où l'hérédité. On a donc montré par récurrence que $\forall n$, on peut trouver $\text{ZIV}_n$\footnote{dans notre cas comme on a des blocs de 16 \hyperref[byte]{bytes}, $n\in\llbracket0;~15\rrbracket$}.\\
