...
\end{tikzpicture}
\caption{Fonctionnement d'AES CTR, avec $\text{AES}_k$ le chiffrement d'un bloc par AES avec la clef secrète $k$}
\label{aesctr}
\end{figure}
...
\begin{tikzpicture}
	...
	\fill[green!20, opacity=0.5] (-0.8,-0.1) rectangle (7.7,-2.5);
